...
function Mapa({ allData }) {
  ...
  useEffect(() => {
    //   axios("https://retrozadar.com/.netlify/functions/fetch", {
    //     method: "get",
    //     mode: "no-cors",
    //     headers: {
    ...
    //     setAllDataFetch(allData.data.allData);
    //   });
  }, []);
